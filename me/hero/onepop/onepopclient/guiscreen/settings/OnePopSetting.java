package me.hero.onepop.onepopclient.guiscreen.settings;

import java.util.List;
import me.hero.onepop.onepopclient.hacks.OnePopHack;

public class OnePopSetting {
   private OnePopHack master;
   private String name;
   private String tag;
   ...
   public OnePopSetting(OnePopHack master, String name, String tag, boolean value) {
      this.master = master;
      this.name = name;
      this.tag = tag;
      this.button = value;
   ...
   public OnePopSetting(OnePopHack master, String name, String tag, List<String> values, String value) {
      this.master = master;
      this.name = name;
      this.tag = tag;
   ...
   public OnePopSetting(OnePopHack master, String name, String tag, String value) {
      this.master = master;
      this.name = name;
      this.tag = tag;
      this.label = value;
   ...
   public OnePopSetting(OnePopHack master, String name, String tag, double value, double min, double max) {
      this.master = master;
      this.name = name;
      this.tag = tag;
      this.slider = value;
   ...
   public OnePopSetting(OnePopHack master, String name, String tag, int value, int min, int max) {
      this.master = master;
      this.name = name;
      this.tag = tag;
